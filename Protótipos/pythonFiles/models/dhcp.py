...
class Dhcp(Ip):
    ...
    def __init__(self: object, interface: str,  ipv4: str, gateway: str, dns1: str, dns2: str, sub_net_mask: str, dhcp_pool_inicial: str, dhcp_pool_final: str, logger: object) -> None:
